	...
	<div class="container">
		...
		<div class="blog">
			...
			<a href="page-blog1.php" id="jose-maria" class="blog__item">
				<img data-src="https://pixboost.com/api/2/img/http://artine-photography.epizy.com/img/gallery/kendra-allen/thumb-1.jpg/optimise?auth=MzM0ODY5MzE0OA__" class="img-fit lazy" width="400px" height="300px">
			...
			<a href="page-blog3.php" id="baby-zhou" class="blog__item">
				<img data-src="https://pixboost.com/api/2/img/http://artine-photography.epizy.com/img/gallery/minnie-zhou/thumb-1.jpg/optimise?auth=MzM0ODY5MzE0OA__" class="img-fit lazy" width="400px" height="300px">
			...
			<a href="page-blog4.php" id="ana-7th" class="blog__item">
				<img data-src="https://pixboost.com/api/2/img/http://artine-photography.epizy.com/img/gallery/ana-tavares/thumb-1.jpg/optimise?auth=MzM0ODY5MzE0OA__" class="img-fit lazy" width="400px" height="300px">
